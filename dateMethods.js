...
// 6 getFullYear
console.log(new Date('2002-10-25').getFullYear());
...
// 12 setDate
let date8= new Date('2023-12-25').setDate(10);
...
// 30 setUTCDate
let date26= new Date('2020-07-15').setUTCDate(12);
